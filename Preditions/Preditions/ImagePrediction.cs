...
namespace Preditions
{
    ...
    {
        private static string fileDetail = Path.Combine(Application.StartupPath,"..", "..", "imageClassificationDescription.txt");
        ...
        {
            InitializeComponent();
            string text = File.ReadAllText(fileDetail);
        ...
        private void PrepareDataToRequest()
        {
            ...
            NetworkManager.Instance.SendImageRequest(data, OnServerResponse);
