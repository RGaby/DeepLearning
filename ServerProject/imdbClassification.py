...
class IMDBClassification(BaseNetwork):
    ...
    def __init__(self, batch_size, epochs):        
        ...
        self.save_dir = '../NeuralNetworkScripts/saved_models'
    ...
    def CreateModel(self):
        ...
        model = Sequential()
        model.add(Embedding(top_words, embedding_vecor_length, input_length=self.max_review_length))
    ...
    def Predict(self, predict_data, forceTrain = True):
